...
<div id="pq-loading">
    <div id="pq-loading-center">
        <img src="{{asset('assets/images/logos/loader.png')}}" alt="loading">
    </div>
</div>
<!-- Loading -->
                    ...
                    <div class="pq-header-contact">
                        <ul>
                            <li>
                                ...
                                <span>Envato HQ 24 Fifth st Angeles, USA</span>
                            </li>
                            <li>
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index-2.html">
                            <img class="img-fluid logo" src="{{asset('assets/images/logos/header-logo-white.png')}}" alt="lawfic">
                        </a>
                                ...
                                <ul id="pq-main-menu" class="navbar-nav ml-auto">
                                    ...
                                    <!-- <li class="menu-item menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="menu-item">
                                                <a href="stop-forcloasure-law.html">Stop Forcloasure Law</a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="real-estate-home.html">Real Estate &amp; Home</a>
                                            </li>
                                            <li class="menu-item">
                                    ...
                                    <li class="menu-item menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="menu-item">
                                                <a href="personal-statement.html">Portfolio Single</a>
                                            </li>
                                        </ul>
                                    </li> -->
                                    <li class="menu-item menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="menu-item">
                                                <a href="principle-of-precedent-to-establish-consistency.html">Blog Single</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="menu-item">
                        ...
                        <div class="pq-btn-container">
                            <div class="pq-button-block">
                                <a href="contact-us" class="pq-button pq-button-flat">
                                    <span class="pq-button-text">free consultation</span>
                                </a>
                            </div>
                        </div>
